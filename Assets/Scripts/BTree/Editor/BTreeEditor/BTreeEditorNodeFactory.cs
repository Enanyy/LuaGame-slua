    ...
    class BTreeEditorNodeFactory
    {
        ...
        public static BTreeNodeDesigner[] CreateBTreeNodeDesignerFromConfig(BTreeEditorTreeConfig _config)
        {
            ...
            for (int i = 0; i < _nodeDesigners.Length; i++)
            {
                ...
                if (_editorNode.m_Node.parent != null)
                {
                    int _parentIndex = _editorNode.m_Node.parent.index;
        ...
        public static BTreeNodeDesigner CreateBTreeNodeDesigner(BTreeEditorNodeConfig[] _configNodes, BTreeEditorNode[] _editorNodes, ref BTreeNodeDesigner[] _nodeDesigners, int _index)
        {
            ...
            for (int i = 0; i < _editorNode.m_Node.childCount; i++)
            {
                int _childIndex = _editorNode.m_Node.children[i].index;
        ...
        {
            TreeConfig _treeConfig = BTFactory.CreateConfigFromBTreeRoot(_rootEditorNode.m_EditorNode.m_Node);
        ...
        {
            BTNode _root = _graphDesigner.m_RootNode.m_EditorNode.m_Node;
